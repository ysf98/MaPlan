...
export function PendingInvitationCard({ invitation }: PendingInvitationCardProps) {
  ...
  return (
    <section className="rounded-[28px] border-2 border-rose-300 bg-white px-5 py-5 shadow-[0_14px_35px_rgba(198,40,58,0.16)]">
      <div className="flex items-start gap-3">
        ...
        <div className="min-w-0 flex-1">
          <h2 className="text-base font-extrabold text-zinc-800">Invitacion pendiente</h2>
          <p className="mt-3 text-sm font-bold text-zinc-700">{invitation.groupName || "Grupo privado"}</p>
      ...
      <form action={formAction} className="mt-5 grid grid-cols-2 gap-3">
        ...
        <button
          className="h-12 rounded-2xl bg-[#c6283a] text-sm font-extrabold text-white shadow-sm transition hover:bg-[#a91f31] disabled:cursor-not-allowed disabled:opacity-60"
          disabled={isPending}
          name="decision"
          type="submit"
          value="accepted"
        ...
        <button
          className="h-12 rounded-2xl bg-rose-100 text-sm font-extrabold text-zinc-700 transition hover:bg-rose-200 disabled:cursor-not-allowed disabled:opacity-60"
          disabled={isPending}
          name="decision"
          type="submit"
          value="rejected"
